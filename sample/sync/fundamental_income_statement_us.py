...
异步用法相同, 路径为 gangtise.async_.fundamental.income_statement_us(...)。
"""
...
def main():
    # 示例 1 · 最简调用: 仅传必填美股代码
    show_result(
        gangtise.fundamental.income_statement_us(security_code="AAPL.O"),  # 单个美股代码
        __file__,
    )

    # 示例 2 · 时间窗 + 报告期过滤
    show_result(
        gangtise.fundamental.income_statement_us(
