...
异步用法相同, 路径为 gangtise.async_.insight.announcement_us_list(...)。
"""
...
def main():
    ...
    show_result(gangtise.insight.announcement_us_list(size=5, security="TSLA.O"), __file__)

    # 示例 2 · 全文检索 + 时间窗
    show_result(
        gangtise.insight.announcement_us_list(
