...
异步用法相同, 路径为 gangtise.async_.fundamental.income_statement(...)。
"""
...
def main():
    ...
    show_result(
        gangtise.fundamental.income_statement(security_code="000001.SZ"),  # 单个证券代码
        __file__,
    )

    # 示例 2 · 时间窗 + 财年过滤
    show_result(
        gangtise.fundamental.income_statement(
