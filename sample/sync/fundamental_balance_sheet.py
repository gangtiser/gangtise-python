...
异步用法相同, 路径为 gangtise.async_.fundamental.balance_sheet(...)。
"""
...
def main():
    # 示例 1 · 最简调用: 仅传必填证券代码
    show_result(
        gangtise.fundamental.balance_sheet(security_code="000001.SZ"),  # 单个证券代码
        __file__,
    )

    # 示例 2 · 时间窗 + 财年过滤
    show_result(
        gangtise.fundamental.balance_sheet(
