...
class Insight:
    ...
    def opinion_list(
        ...
        *,
        ...
        chief: StrOrList | None = None,
        security: StrOrList | None = None,
        broker: StrOrList | None = None,
        industry: StrOrList | None = None,
        concept: StrOrList | None = None,
        llm_tag: StrOrList | None = None,
    ...
    def summary_list(
        ...
        *,
        ...
        market: StrOrList | None = None,
        participant_role: StrOrList | None = None,
        raw: bool = False,
    ) -> pd.DataFrame | dict[str, Any]:
    ...
    def roadshow_list(
        ...
        *,
        ...
        market: StrOrList | None = None,
        participant_role: StrOrList | None = None,
        broker_type: StrOrList | None = None,
        permission: StrOrList | None = None,
    ...
    def research_list(
        ...
        *,
        ...
        category: StrOrList | None = None,
        llm_tag: StrOrList | None = None,
        rating: StrOrList | None = None,
        rating_change: StrOrList | None = None,
    ...
    def official_account_list(
        ...
        *,
        ...
        search_type: int = 1,
        rank_type: int = 1,
        account_id: StrOrList | None = None,
        security: StrOrList | None = None,
        category: StrOrList | None = None,
        industry: StrOrList | None = None,
        raw: bool = False,
