...
异步路径为 gangtise.async_.quote.day_kline_us(...)。
"""
...
async def main():
    # 示例 1 · 最简调用: 取单只美股最近一段日 K 线
    show_result(
        await gangtise.async_.quote.day_kline_us(
            security="UBER.N",  # 美股代码, 如 UBER.N / AAPL.O; 支持单值或列表; "all"=全市场
    ...
    show_result(
        await gangtise.async_.quote.day_kline_us(
            security=["UBER.N", "AAPL.O"],  # 支持单值或列表
