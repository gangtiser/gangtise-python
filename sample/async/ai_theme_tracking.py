...
async def main():
    ...
    #   await gangtise.async_.ai.theme_tracking(theme_id="121000130", date="2026-08-28")
    #   # 同时取早报与晚报(列表入参):
    #   await gangtise.async_.ai.theme_tracking(
    #       theme_id="121000130", date="2026-08-28", type_=["morning", "night"]
    #   )
    #   # raw=True 返回服务端原始 data:
    #   await gangtise.async_.ai.theme_tracking(theme_id="121000130", date="2026-08-28", raw=True)
